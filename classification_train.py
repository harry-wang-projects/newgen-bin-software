...
#initial convolution
model.add(Conv2D(64, (7, 7), input_shape = x.shape[1:], activation = "relu", kernel_regularizer=regularizers.l2(l=0.01)))
...
#run the model
model.fit(xtrain, ytrain, batch_size = 256, epochs = 40, callbacks = [tensorboard_callback, cm_callback], validation_data=(xval, yval))
